...
exports.default = {
  ...
  methods: {
    ...
    createInput: function createInput(h, data, children, defaultAction) {
      ...
      }, [this.createIcon(h), this.createLabel(h), h('div', data, [this.prefix && !this.float ? h('span', { staticClass: 'mu-input-prefix-text' }, this.prefix) : undefined].concat((0, _toConsumableArray3.default)(children), [this.suffix && !this.float ? h('span', { staticClass: 'mu-input-suffix-text' }, this.suffix) : undefined, defaultAction || this.createActionIcon(h), this.createUnderline(h), this.createHelpText(h)]))]);
    }
  },
  watch: {
